...
# 25 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
...
# 50 "/usr/include/x86_64-linux-gnu/sys/msg.h" 3 4
struct msgbuf
  {
...
# 14 "aio_read.c" 3 4
                 1
# 14 "aio_read.c"
                              , (void*)req->aio_buf, req->aio_nbytes);
        }
...
# 28 "aio_read.c"
    ...
    rd.aio_buf = malloc(1024 + 1);
    bzero((void*)rd.aio_buf, 1024 +1);

    rd.aio_fildes = fd;
    rd.aio_nbytes = 1024;
    rd.aio_offset = 0;

    rd.aio_sigevent.sigev_notify = 
# 43 "aio_read.c" 3 4
                                  SIGEV_SIGNAL
# 43 "aio_read.c"
                                              ;
